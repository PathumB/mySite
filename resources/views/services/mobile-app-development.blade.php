        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="inner-content paroller text-center">
                    <div class="title">
                        <h2>Mobile App <br/>Design & Development</h2>
                    </div>
            ...
            <div class="col-xl-12">
                <div class="service-deails-box">
                    ...
                    <div class="service-details-content-box">
                        <div class="icon">
                            <img src="{{ asset('images/service-v2-2.png') }}" alt="">
                        </div>
                        <div class="text">
                            <h3>Crafting Intuitive Mobile Experiences</h3>
                            <div class="inner-text">
                                <p>Delve into our mobile app design and development services where creativity converges with functionality. We specialize in crafting intuitive and engaging mobile experiences across platforms, ensuring your app stands out in today's competitive digital landscape.</p>
                            </div>
                        </div>
                    </div>
