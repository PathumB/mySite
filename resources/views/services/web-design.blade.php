            ...
            <div class="col-xl-12">
                <div class="service-deails-box">
                    ...
                    <div class="service-details-content-box">
                        <div class="icon">
                            <img src="{{ asset('images/service-v2-1.png') }}" alt="">
                        </div>
                        <div class="text">
                            <h3>Innovative Interactive Interfaces</h3>
                            <div class="inner-text">
                                <p>Explore the forefront of web design with our innovative interactive interfaces. Engage users with seamless navigation, captivating visuals, and intuitive functionalities, ensuring an immersive and memorable online experience that sets your brand apart in the digital landscape.</p>
                            </div>
                        </div>
                    </div>
