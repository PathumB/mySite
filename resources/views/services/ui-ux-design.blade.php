            ...
            <div class="col-xl-12">
                <div class="service-deails-box">
                    ...
                    <div class="service-details-content-box">
                        <div class="icon">
                            <img src="{{ asset('images/service-v2-3.png') }}" alt="">
                        </div>
                        <div class="text">
                            <h3>Elevating User Experiences through Design</h3>
                            <div class="inner-text">
                                <p>Explore our UI/UX design services where form meets function. We meticulously craft intuitive interfaces and seamless interactions to ensure exceptional user experiences. From wireframes to prototypes, we prioritize user-centric design to create memorable digital journeys for your audience.</p>
                            </div>
                        </div>
                    </div>
